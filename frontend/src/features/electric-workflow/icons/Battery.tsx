export default function Battery({ height }: { height?: number }) {
    return (
        ...
        //         <g>
        //             {" "}
        //             <polygon points="298,141 182,141 182,116 166,116 166,182 182,182 182,157 298,157 "></polygon>{" "}
        //             <polygon points="116,141 0,141 0,157 116,157 116,215 132,215 132,83 116,83 "></polygon>{" "}
        //         </g>{" "}
        //     </g>
        // </svg>
    );
